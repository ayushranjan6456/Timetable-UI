...
function viewtt() {
    ...
    if (timetable.length == 279) {
        ...
        document.getElementById('stud_tt').style.border = '1px solid #b0b3b9';
        checks = checks + 1
    }
    else {
        document.getElementById('textareaerror').style.display = 'inline';
        document.getElementById('stud_tt').style.border = '1.2px solid #cc280b';
    }
    patt = new RegExp(/[\d]{2}[\w]{3}[\d]{4}/);
    if (reg_no.length == 9 && patt.test(reg_no)) {
        document.getElementById('reg_no_error').style.display = "none";
        document.getElementById('reg_no').style.border = '1px solid #b0b3b9';
        checks = checks + 1
    }
    else {
        document.getElementById('reg_no_error').style.display = 'inline';
        document.getElementById('reg_no').style.border = '1.2px solid #cc280b';
